 ...
 * @h: pointer to node a first position
 * Return: list size
 */
 ...
 * @head: pointer to node at the first position
 ...
 * @h: pointer to the node at the first position
 * Return: list size
 */
...
/**
 * node_starts_with - returns node of string
 * @node: head of the list
 * @prefix: stirng to be matched
